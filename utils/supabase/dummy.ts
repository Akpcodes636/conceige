...
/**
 * Dummy blog posts used until Supabase is configured.
 * Replace with real data once NEXT_PUBLIC_SUPABASE_URL and
...
export const dummyBlogPosts: BlogPost[] = [
  {
    ...
    alt_text: "Older couple sitting together on a porch",
  ...
  },
  {
    ...
    image_url: "/images/blog-2.png",
    alt_text: "Carer laughing with an older woman at home",
  ...
  },
  {
    ...
    image_url: "/images/blog-3.png",
    alt_text: "Older man sitting alone by a window",
    ...
    content: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The pandemic accelerated an existing trend. Older adults who had structured social contact through day centres, community groups, and regular visits from family found those routines severed — and for many, they never fully resumed.",
        ],
      },
      {
        heading: "What Loneliness Does to the Body",
        paragraphs: [
          "The health consequences of chronic social isolation are broad and well-documented. Loneliness is associated with elevated cortisol (the stress hormone), higher blood pressure, disrupted sleep, weakened immune function, and accelerated cognitive decline.",
          "A landmark study from Rush University Medical Centre found that socially isolated seniors experienced a rate of cognitive decline approximately 70% faster than their socially engaged peers.",
        ],
      },
      {
