...
export const SIGNS = [
  ...
  "Skipping meals or an empty fridge",
  "Forgetting to take medication on time",
  "Unopened post and unpaid bills piling up",
  "Struggling with stairs, or a recent fall",
  "Seeing fewer friends and leaving the house less",
];
...
export const PACKAGES = [
  {
    ...
    standard: "€130/week · €520/month",
    price: "€54/week · €216/month",
  ...
  },
  {
    ...
    standard: "€360/week · €1,440/month",
    price: "€216/week · €864/month",
    note: "After 60% tax relief",
    featured: false,
  },
];
...
export const footerColumns: FooterColumn[] = [
  ...
  {
    title: "Get in touch",
    links: [{ label: "Contact", href: "/Request-consultation" }],
  },
];
...
export const services: Service[] = [
  ...
  },
  {
    id: "companionship",
    title: "Companionship & Social Engagement",
    description: "Bringing joy, connection, and meaningful conversation into every day.",
  ...
  },
  {
    id: "transport",
    title: "Transport & Errands Support",
    description: "Keeping seniors connected to their community, routines, and appointments.",
  ...
  },
  {
    ...
    title: "Care Coordination Services",
    description: "Streamlining the details so you can focus on being a family.",
  ...
  },
  {
    id: "admin-virtual",
    title: "Administrative & Virtual Support",
    description: "Remote digital support and appointment coordination for families near and far.",
    image: "/images/image-8.jpg",
  alt_text: "A carer helping an older woman with paperwork at a bookshelf",
  },
];
