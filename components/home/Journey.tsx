    ...
    <section>
      <div className="container mx-auto">
        <div className="py-[48px]">
          ...
          <h1 className="font-poppins text-[24px] md:text-[28px] lg:text-[39px] leading-[160%] text-center font-semibold mb-[8px] md:mb-[16px]" >Support That Puts Families at Ease</h1>
          <p className="font-body text-[18px] leading-[160%] text-[#1C2A38] font-normal max-w-full mx-auto md:max-w-full lg:max-w-[900px] text-center mb-[32px]">
