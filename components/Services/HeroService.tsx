    ...
    <section className="bg-[#5B805F]">
      <div className="container mx-auto">
        <div className="pt-[259px] md:pt-[250px] pb-[86px]">
          ...
          <p className="text-[16px] md:text-[24px] text-[#FFFFFF] text-left md:text-center lg:text-center leading-[160%] font-body w-full max-w-full md:max-w-full lg:max-w-[796px] mx-auto mb-[16px]">
