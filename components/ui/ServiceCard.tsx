  ...
  return (
    <article className="group relative mx-auto h-[321px] w-full max-w-[345px] overflow-hidden rounded-[16px] bg-[#1A1614] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0px_16px_32px_0px_#00000040] motion-reduce:transition-none motion-reduce:hover:translate-y-0">
      ...
      <div className="absolute inset-x-0 bottom-4 p-5">
        <span aria-hidden="true" className="mb-3 block h-[5px] w-[76px] rounded-full bg-[#E0A64B]" />
        <h3 className="text-[24px] font-semibold leading-[100%] text-white font-body">{service.title}</h3>
        <p className="mt-2 text-[18px] font-medium leading-[100%] text-white font-body">{service.description}</p>
      </div>
    </article>
  );
}
